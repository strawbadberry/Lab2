...
static int maxDistance = INT_MIN; 
static int minDistance = INT_MAX;
static boolean isFirstData = true; 

// TODO: change the service UUID to the one you are using on the server side.
// The remote service we wish to connect to.
static BLEUUID serviceUUID("9e1fb443-8c53-4fee-b924-86e222348122");
// The characteristic of the remote service we are interested in.
static BLEUUID    charUUID("d3cc5929-1fca-454b-b359-73c9fa97af7f");
...
static void notifyCallback(
  ...
  bool isNotify) {
    ...
    int currentDataInt = round(currentData * 100); 
    ...
    Serial.println(maxDistance / 100.0, 2); 
    Serial.print("Min Distance: ");
    Serial.println(minDistance / 100.0, 2); 
}
